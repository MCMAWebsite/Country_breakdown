...
country_breakdown_dir <- paste0(user_docs, "/Website/Country_breakdown")
...
mcma_objs = readRDS(paste0(country_breakdown_dir, "/RDSfiles/all_conjs"))
all_conjs = readRDS(paste0(country_breakdown_dir, "/RDSfiles/all_conjs"))
all_conjs_expanded = readRDS(paste0(country_breakdown_dir, "/RDSfiles/all_conjs_expanded"))
derelicts = readRDS(paste0(country_breakdown_dir, "/RDSfiles/derelicts"))
derelictDat = readRDS(paste0(country_breakdown_dir, "/RDSfiles/derelictDatNew"))
alt_bins = readRDS(paste0(country_breakdown_dir, "/RDSfiles/alt_bins"))
file_list = readRDS(paste0(country_breakdown_dir, "/RDSfiles/file_list"))
all_conjs_2016 = readRDS(paste0(country_breakdown_dir, "/RDSfiles/all_conjs_2016"))
